    ...
    <div className="space-y-3">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-9 pr-3 py-2 text-sm border border-dark-200 rounded-xl bg-dark-50 focus:outline-none focus:ring-2 focus:ring-primary-400 focus:border-transparent"
        />
      </div>
      ...
      <div className="divide-y divide-dark-100 border border-dark-200 rounded-xl overflow-hidden">
        {filtered.length === 0 ? (
          <p className="px-4 py-3 text-sm text-dark-400 text-center">검색 결과가 없습니다</p>
        ) : (
          filtered.map((e) => {
