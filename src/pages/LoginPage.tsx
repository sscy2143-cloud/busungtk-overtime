      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <div
            ...
            className="w-16 h-16 bg-primary-500 rounded-2xl flex items-center justify-center mx-auto mb-4 cursor-default select-none"
          >
            <span className="text-white text-2xl font-bold">부</span>
          </div>
          <h1 className="text-2xl font-bold text-dark-900">부성TK 근태관리</h1>
          <p className="text-sm text-dark-500 mt-1">야근·휴가 통합 관리 시스템</p>
        </div>

        {/* 구분선 */}
        <div className="border-t border-dark-100 mb-6" />
        ...
        <form onSubmit={handleLogin} className="space-y-3">
          ...
          <button
            ...
            className="w-full py-3 bg-primary-500 text-white text-sm font-semibold rounded-xl hover:bg-primary-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        {devMode && (
          <div className="mt-6 pt-6 border-t border-dark-100">
            <p className="text-xs text-dark-400 text-center mb-3">개발자 모드</p>
            <form onSubmit={handleDemoLogin} className="space-y-2">
              ...
              <button
                type="submit"
                className="w-full py-2 bg-dark-800 text-white text-xs font-medium rounded-lg hover:bg-dark-900 transition-colors"
              >
                관리자 데모 로그인
              </button>
            </form>
