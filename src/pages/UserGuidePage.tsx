    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between print:hidden">
        <div className="flex items-center gap-3">
          <button onClick={() => navigate(-1)} className="p-1.5 hover:bg-dark-50 rounded-lg transition-colors">
            <ChevronLeft size={20} className="text-dark-500" />
          </button>
          <h1 className="text-xl font-bold text-dark-900">이용 가이드</h1>
        </div>
        <button
          onClick={() => window.print()}
          className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-primary-500 rounded-lg hover:bg-primary-500 transition-colors"
        >
          <Printer size={16} />
          PDF 저장 / 인쇄
        </button>
      ...
      {/* 가이드 본문 */}
      <div className="bg-white rounded-2xl border border-dark-100 shadow-[0_1px_3px_rgba(0,0,0,0.04)] p-8 print:shadow-none print:border-0 print:p-0 max-w-4xl mx-auto">
        {/* 표지 */}
        <div className="text-center mb-12 print:mb-8 pb-8 border-b-2 border-primary-200">
          ...
          <h1 className="text-2xl font-bold text-dark-900 mb-2">부성TK 근태관리 시스템</h1>
          <h2 className="text-lg font-semibold text-primary-500 mb-4">이용 가이드</h2>
        ...
        <section className="mb-10">
          <h2 className="text-lg font-bold text-dark-900 mb-4 pb-2 border-b border-dark-200">목차</h2>
          <ol className="space-y-1.5 text-sm text-dark-700 list-decimal list-inside">
        ...
        <section id="sec1" className="mb-10">
          <h2 className="text-lg font-bold text-dark-900 mb-3 pb-2 border-b border-dark-200">1. 시스템 접속 및 로그인</h2>
          <div className="space-y-3 text-sm text-dark-700 leading-relaxed">
            ...
            <h3 className="font-semibold text-dark-800 mt-4">1-2. 로그인</h3>
            <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <h3 className="font-semibold text-dark-800 mt-4">1-3. 로그아웃</h3>
            <ul className="list-disc list-inside space-y-1 ml-2">
        ...
        <section id="sec2" className="mb-10">
          <h2 className="text-lg font-bold text-dark-900 mb-3 pb-2 border-b border-dark-200">2. 대시보드 안내</h2>
          <div className="space-y-3 text-sm text-dark-700 leading-relaxed">
            <p>로그인 후 가장 먼저 보이는 화면입니다. 주요 정보를 한눈에 확인할 수 있습니다.</p>

            <h3 className="font-semibold text-dark-800 mt-4">2-1. 금주 연장근무시간</h3>
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li>이번 주(월~일) 승인된 연장근무 시간을 게이지로 표시</li>
              <li>색상별 의미: 초록 → 노랑(8시간 이상) → 빨강(10시간 이상)</li>
            </ul>

            <h3 className="font-semibold text-dark-800 mt-4">2-2. 잔여 연차</h3>
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li>올해 총 연차 일수와 사용/잔여 일수를 확인</li>
              <li>게이지 바로 잔여 비율을 시각적으로 확인 가능</li>
            </ul>

            <h3 className="font-semibold text-dark-800 mt-4">2-3. 빠른 액션</h3>
            <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <h3 className="font-semibold text-dark-800 mt-4">2-4. 최근 제출</h3>
            <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <h3 className="font-semibold text-dark-800 mt-4">2-5. 공지사항 / 급여명세서</h3>
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li>최근 공지사항 2건, 급여명세서 2건 미리보기</li>
              <li>"전체보기"를 클릭하면 전체 목록 페이지로 이동</li>
            </ul>

            <div className="bg-primary-50 border border-primary-100 rounded-xl px-4 py-3 mt-3">
        ...
        <section id="sec3" className="mb-10">
          <h2 className="text-lg font-bold text-dark-900 mb-3 pb-2 border-b border-dark-200">3. 연장근무 신청</h2>
          <div className="space-y-3 text-sm text-dark-700 leading-relaxed">
            <h3 className="font-semibold text-dark-800 mt-4">3-1. 신청 방법</h3>
            ...
            <h3 className="font-semibold text-dark-800 mt-4">3-2. 근무 유형별 설명</h3>
            <table className="w-full text-xs border-collapse mt-2">
              <thead>
                <tr className="bg-dark-50">
                  <th className="border border-dark-200 px-3 py-2 text-left font-semibold">유형</th>
                  <th className="border border-dark-200 px-3 py-2 text-left font-semibold">설명</th>
                </tr>
              </thead>
              <tbody>
                <tr><td className="border border-dark-200 px-3 py-2">연장근무</td><td className="border border-dark-200 px-3 py-2">정규 근무시간 이후 추가 근무</td></tr>
                <tr><td className="border border-dark-200 px-3 py-2">야간근무</td><td className="border border-dark-200 px-3 py-2">22:00 ~ 06:00 사이 근무</td></tr>
                <tr><td className="border border-dark-200 px-3 py-2">휴일근무</td><td className="border border-dark-200 px-3 py-2">주말 또는 공휴일 근무</td></tr>
              </tbody>
            </table>

            <h3 className="font-semibold text-dark-800 mt-4">3-3. 승인 과정</h3>
            <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <h3 className="font-semibold text-dark-800 mt-4">3-4. 신청 내역 확인</h3>
            <ul className="list-disc list-inside space-y-1 ml-2">
        ...
        <section id="sec4" className="mb-10">
          <h2 className="text-lg font-bold text-dark-900 mb-3 pb-2 border-b border-dark-200">4. 근무 기록 확인</h2>
          <div className="space-y-3 text-sm text-dark-700 leading-relaxed">
            <ul className="list-disc list-inside space-y-1 ml-2">
        ...
        <section id="sec5" className="mb-10">
          <h2 className="text-lg font-bold text-dark-900 mb-3 pb-2 border-b border-dark-200">5. 휴가 신청</h2>
          <div className="space-y-3 text-sm text-dark-700 leading-relaxed">
            <h3 className="font-semibold text-dark-800 mt-4">5-1. 신청 방법</h3>
            <ol className="list-decimal list-inside space-y-1 ml-2">
            ...
            <h3 className="font-semibold text-dark-800 mt-4">5-2. 휴가 유형</h3>
            <table className="w-full text-xs border-collapse mt-2">
              <thead>
                <tr className="bg-dark-50">
                  <th className="border border-dark-200 px-3 py-2 text-left font-semibold">유형</th>
                  <th className="border border-dark-200 px-3 py-2 text-left font-semibold">차감</th>
                  <th className="border border-dark-200 px-3 py-2 text-left font-semibold">설명</th>
                </tr>
              </thead>
              <tbody>
                <tr><td className="border border-dark-200 px-3 py-2">연차</td><td className="border border-dark-200 px-3 py-2">1일</td><td className="border border-dark-200 px-3 py-2">종일 휴가</td></tr>
                <tr><td className="border border-dark-200 px-3 py-2">오전반차</td><td className="border border-dark-200 px-3 py-2">0.5일</td><td className="border border-dark-200 px-3 py-2">오전 중 휴가 (오후 출근)</td></tr>
                <tr><td className="border border-dark-200 px-3 py-2">오후반차</td><td className="border border-dark-200 px-3 py-2">0.5일</td><td className="border border-dark-200 px-3 py-2">오후 휴가 (오전만 근무)</td></tr>
                <tr><td className="border border-dark-200 px-3 py-2">기타</td><td className="border border-dark-200 px-3 py-2">별도</td><td className="border border-dark-200 px-3 py-2">경조사, 교육 등 특별휴가</td></tr>
              </tbody>
            </table>

            <h3 className="font-semibold text-dark-800 mt-4">5-3. 잔여 연차 확인</h3>
            <ul className="list-disc list-inside space-y-1 ml-2">
        ...
        <section id="sec6" className="mb-10">
          <h2 className="text-lg font-bold text-dark-900 mb-3 pb-2 border-b border-dark-200">6. 경비 제출 및 수령확인</h2>
          <div className="space-y-3 text-sm text-dark-700 leading-relaxed">
            <h3 className="font-semibold text-dark-800 mt-4">6-1. 경비 제출</h3>
            <ol className="list-decimal list-inside space-y-1 ml-2">
            ...
            <h3 className="font-semibold text-dark-800 mt-4">6-2. 경비 처리 과정</h3>
            <div className="bg-dark-50 rounded-xl px-4 py-3">
              <div className="flex items-center gap-2 text-xs text-dark-600 flex-wrap">
                <span className="px-2 py-1 bg-dark-100 text-dark-700 rounded font-semibold">제출(검토중)</span>
                <span>→</span>
                <span className="px-2 py-1 bg-dark-100 text-dark-700 rounded font-semibold">승인</span>
                <span>→</span>
                <span className="px-2 py-1 bg-primary-50 text-primary-700 rounded font-semibold">지급처리</span>
                <span>→</span>
                <span className="px-2 py-1 bg-primary-100 text-primary-800 rounded font-semibold">수령확인</span>
              </div>
            </div>

            <h3 className="font-semibold text-dark-800 mt-4">6-3. 수령확인</h3>
            <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <h3 className="font-semibold text-dark-800 mt-4">6-4. 취소 요청</h3>
            <ul className="list-disc list-inside space-y-1 ml-2">
        ...
        <section id="sec7" className="mb-10">
          <h2 className="text-lg font-bold text-dark-900 mb-3 pb-2 border-b border-dark-200">7. 급여명세서 확인</h2>
          <div className="space-y-3 text-sm text-dark-700 leading-relaxed">
            <h3 className="font-semibold text-dark-800 mt-4">7-1. 열람 방법</h3>
            <ol className="list-decimal list-inside space-y-1 ml-2">
            ...
            <h3 className="font-semibold text-dark-800 mt-4">7-2. 상세 보기</h3>
            <ul className="list-disc list-inside space-y-1 ml-2">
        ...
        <section id="sec8" className="mb-10">
          <h2 className="text-lg font-bold text-dark-900 mb-3 pb-2 border-b border-dark-200">8. 공지사항 확인</h2>
          <div className="space-y-3 text-sm text-dark-700 leading-relaxed">
            <ul className="list-disc list-inside space-y-1 ml-2">
        ...
        <section id="sec9" className="mb-10">
          <h2 className="text-lg font-bold text-dark-900 mb-3 pb-2 border-b border-dark-200">9. 알림</h2>
          <div className="space-y-3 text-sm text-dark-700 leading-relaxed">
            <ul className="list-disc list-inside space-y-1 ml-2">
        ...
        <section id="sec11" className="mb-6">
          <h2 className="text-lg font-bold text-dark-900 mb-3 pb-2 border-b border-dark-200">11. 자주 묻는 질문 (FAQ)</h2>
          <div className="space-y-4 text-sm text-dark-700">
            {[
              ...
              <div key={i} className="bg-dark-50 rounded-xl px-4 py-3">
                <p className="font-semibold text-dark-800 mb-1">{item.q}</p>
                <p className="text-dark-600">{item.a}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        {/* 하단 */}
        <div className="text-center pt-6 border-t border-dark-200">
